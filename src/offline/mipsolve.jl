...
"""
    `mipFlow`: take FlowProblem, give Flow Solution
"""
mipFlow2(l::FlowProblem; args...) = mipFlow2(l, Nullable{FlowSolution}(); args...)
mipFlow2(l::FlowProblem, s::FlowSolution; args...) =
    mipFlow2(l, Nullable{FlowSolution}(s); args...)
function mipFlow2(l::FlowProblem, s::Nullable{FlowSolution}; verbose::Bool=true, solverArgs...)
